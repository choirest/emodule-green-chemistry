...
const Kegiatan1 = () => {
  ...
  // Reusable NOTECHEM card
  const NotechemCard = ({ children }) => (
  ...
  const prinsipNav = [
    { id: '1', src: '/p1.png', label: 'Waste Prevention' },
    { id: '2', src: '/p2.png', label: 'Atom Economy' },
    { id: '3', src: '/p3.png', label: 'Less Hazardous Syntheses' },
    { id: '4', src: '/p4.png', label: 'Designing Safer Chemicals' },
    { id: '5', src: '/p5.png', label: 'Safer Solvents & Auxiliaries' },
    { id: '6', src: '/p6.png', label: 'Design for Energy Efficiency' },
    { id: '7', src: '/p7.png', label: 'Catalyst' },
    { id: '8', src: '/p8.png', label: 'Reduce Derivatives' },
    { id: '9', src: '/p9.png', label: 'Use of Renewable Feedstocks' },
    { id: '10', src: '/p10.png', label: 'Design for Degradation' },
    { id: '11', src: '/p11.png', label: 'Real-time Pollution Prevention' },
    { id: '12', src: '/p12.png', label: 'Safer Chemistry for Accident Prevention' },
  ];
    ...
    <section className="p-4 overflow-hidden">
      <Card className="overflow-hidden">
        <ScrollArea className="h-144 overflow-x-hidden">
          <CardHeader>
            ...
            <CardDescription className="my-4 grid gap-2 text-justify text-black">
              ...
              <div className="flex gap-2">
                <p>1.</p>
                <p>Mendeskripsikan pengertian kimia hijau</p>
              </div>
              <div className="flex gap-2">
                <p>2.</p>
                <p>Mendeskripsikan prinsip kimia hijau</p>
              </div>
            </CardDescription>
            <Separator />
          </CardHeader>
          ...
          <div id="a" className="pt-6 grid gap-16">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                ...
                <p>Simak Video Dibawah ini untuk dapat menafsirkan apa itu arti dari <i>Green Chemistry</i></p>
          ...
          {/* Nav 12 Prinsip */}
          <div className="w-full px-4 md:w-2/3 md:px-8 justify-center mx-auto pb-12">
            <Card className="bg-green-600 p-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {prinsipNav.map(({ id, src, label }) => (
                  <Card key={id} className="bg-white hover:bg-green-100">
                    <button
                      onClick={() => scrollToSection(id)}
                      className="p-2 flex flex-col gap-2 items-center text-center w-full"
                    >
                      <img src={src} alt={label} className="w-16 h-16" />
                      <p className="text-green-600 text-sm">{label}</p>
                    </button>
                  </Card>
                ))}
              </div>
          ...
          <div id="1" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <img src="/prinsip1.jpg" alt="greenchemistry" className="w-full sm:w-1/2 mx-auto mt-4" />
          ...
          <div id="2" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <div className="w-full sm:w-1/2 flex gap-2 mx-auto mt-4">
          ...
          <div id="3" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <img src="/prinsip3.jpg" alt="greenchemistry" className="w-full sm:w-1/2 mx-auto mt-4" />
          ...
          <div id="4" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                ...
                <NotechemCard>
                  <p>Produk pewangi yang ramah lingkungan dan aman tetap memberikan efek harum, tanpa menyebabkan iritasi, alergi, atau pencemaran udara dalam ruangan. Ini adalah contoh nyata dari prinsip "desain yang lebih aman" yaitu membuat sesuatu yang bermanfaat tapi juga tidak membahayakan siapa pun yang menggunakannya.</p>
                </NotechemCard>
              </CardDescription>
            </CardHeader>
          </div>
          ...
          <div id="5" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-2 text-justify text-black">
                ...
                <p>Bayangkan kamu ingin membersihkan noda tinta di meja belajar. Kamu punya dua pilihan:</p>
                <div className="flex gap-2">
                  <p>1.</p>
                  <p><i>Thinner</i> yang bisa menghilangkan noda dengan cepat, tapi baunya menyengat, bisa bikin pusing, dan mudah terbakar.</p>
                </div>
                <div className="flex gap-2">
                  <p>2.</p>
                  <p>Air hangat dicampur cuka yang butuh sedikit lebih banyak usaha, tapi tidak berbahaya bagi tubuh atau lingkungan.</p>
                </div>
                <NotechemCard>
              ...
              <CardDescription className="pt-2 grid gap-2 text-justify text-black">
                ...
                <NotechemCard>
                  ...
                  <ul className="grid gap-1">
                    <li className="flex gap-1"><span>-</span><span>Memilih reaksi kimia yang terjadi pada suhu ruang, bukan dipanaskan 100°C berjam-jam.</span></li>
          ...
          <div id="7" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                ...
                <NotechemCard>
                  <p>Prinsip 7 <i>Green Chemistry</i> sebisa mungkin, produk kimia harus menggunakan bahan baku yang dapat diperbarui, bukan bahan yang berasal dari sumber daya terbatas seperti batu bara, gas alam, atau minyak bumi.</p>
                </NotechemCard>
              </CardDescription>
            </CardHeader>
          </div>
          ...
          <div id="9" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <img src="/prinsip9.jpg" alt="greenchemistry" className="w-full sm:w-1/2 mx-auto mt-4" />
          ...
          <div id="11" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <img src="/prinsip11.jpg" alt="greenchemistry" className="w-full sm:w-1/2 mx-auto mt-4" />
          ...
          <div id="12" className="grid gap-16 pb-6">
            <CardHeader>
              ...
              <CardDescription className="pt-2 grid gap-4 text-justify text-black">
                <img src="/prinsip12.jpg" alt="greenchemistry" className="w-full sm:w-1/2 mx-auto mt-4" />
                ...
                <NotechemCard>
                  <p>Prinsip ke-12 <i>Green Chemistry</i> mendorong kita untuk merancang zat dan proses kimia yang lebih aman, baik dalam penanganan, penggunaan, maupun pembuangannya. Ini berarti menghindari bahan kimia yang mudah meledak, mudah terbakar, atau menghasilkan gas beracun, dan menggantinya dengan alternatif yang tidak reaktif berbahaya. Tujuannya adalah melindungi pekerja, masyarakat, dan lingkungan dari risiko kecelakaan yang bisa terjadi selama produksi, penyimpanan, atau transportasi bahan kimia.</p>
                </NotechemCard>
              </CardDescription>
            </CardHeader>
          </div>
