            ...
            <div className="pt-6 grid gap-16">
              <CardHeader>
                ...
                <CardDescription className="pt-2 grid gap-2 text-justify text-black">
                  <p>
                    <p className="indent-8">                  Pemanfaatan limbah organik sebagai pupuk merupakan salah satu contoh nyata penerapan prinsip kimia
                    ...
                    <p>
                      <p className="indent-8">                  Dalam proses pembuatan pupuk organik, terdapat dua kelompok bahan utama yang perlu disiapkan.
                      ...
                      <p>
                        <p className="indent-8">                  Kedua jenis bahan tersebut harus dicampur dengan perbandingan yang seimbang agar proses
